...
from pyclustering_custom.cluster.tests.gmeans_templates import gmeans_test_template

from pyclustering_custom.cluster.gmeans import gmeans
from pyclustering_custom.utils import read_sample, distance_metric, type_metric

from pyclustering_custom.samples.definitions import SIMPLE_SAMPLES, FCPS_SAMPLES, SIMPLE_ANSWERS
