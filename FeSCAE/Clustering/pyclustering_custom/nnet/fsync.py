...
import numpy
import random
import pyclustering_custom.utils

from scipy.integrate import odeint

from pyclustering_custom.nnet import network, conn_type, conn_represent
...
class fsync_dynamic:
    ...
    def allocate_sync_ensembles(self, tolerance=0.1):
        ...
        return pyclustering_custom.utils.allocate_sync_ensembles(self.__amplitude, tolerance, 0.0)
    ...
    def extract_number_oscillations(self, index, amplitude_threshold):
        ...
        return pyclustering_custom.utils.extract_number_oscillations(self.__amplitude, index, amplitude_threshold);
...
class fsync_visualizer:
    ...
    def show_output_dynamic(fsync_output_dynamic):
        ...
        pyclustering_custom.utils.draw_dynamics(fsync_output_dynamic.time, fsync_output_dynamic.output, x_title = "t", y_title = "amplitude");
    ...
    def show_output_dynamics(fsync_output_dynamics):
        ...
        pyclustering_custom.utils.draw_dynamics_set(fsync_output_dynamics, "t", "amplitude", None, None, False, False);
