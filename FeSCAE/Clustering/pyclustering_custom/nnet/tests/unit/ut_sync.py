...
from pyclustering_custom.nnet.tests.sync_templates import SyncTestTemplates;

from pyclustering_custom.nnet import solve_type, conn_type;
from pyclustering_custom.nnet.sync import sync_network, sync_dynamic, sync_visualizer;
from pyclustering_custom.utils import pi;
