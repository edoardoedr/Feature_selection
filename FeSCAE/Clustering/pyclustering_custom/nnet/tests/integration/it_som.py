...
from pyclustering_custom.nnet.tests.som_templates import SomTestTemplates
from pyclustering_custom.nnet.som import som, type_conn, type_init, som_parameters
