...
from pyclustering_custom.nnet.tests.integration import it_hhn as nnet_hhn_integration_tests
from pyclustering_custom.nnet.tests.integration import it_legion as nnet_legion_integration_tests
from pyclustering_custom.nnet.tests.integration import it_pcnn as nnet_pcnn_integration_tests
from pyclustering_custom.nnet.tests.integration import it_som as nnet_som_integration_tests
from pyclustering_custom.nnet.tests.integration import it_sync as nnet_sync_integration_tests
from pyclustering_custom.nnet.tests.integration import it_syncpr as nnet_syncpr_integration_tests
from pyclustering_custom.nnet.tests.integration import it_syncsegm as nnet_syncsegm_integration_tests
