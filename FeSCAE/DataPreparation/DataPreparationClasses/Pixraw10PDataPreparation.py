...
class Pixraw10PDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "pixraw10P.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_pixraw10p"
    label_column = "label_pixraw10p"

    pixraw_data_prep = Pixraw10PDataPreparation(input_folder, output_folder, label_column)
    processed_data = pixraw_data_prep.process_data()
