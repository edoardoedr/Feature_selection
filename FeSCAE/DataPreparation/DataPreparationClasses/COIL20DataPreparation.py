...
class COIL20DataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "COIL20.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_coil20"
    label_column = "label_coil20"

    coil20_data_prep = COIL20DataPreparation(input_folder, output_folder, label_column)
    processed_data = coil20_data_prep.process_data()
