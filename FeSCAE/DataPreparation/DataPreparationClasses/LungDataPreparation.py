...
class LungDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "lung.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_lung"
    label_column = "label_lung"

    lung_data_prep = LungDataPreparation(input_folder, output_folder, label_column)
    processed_data = lung_data_prep.process_data()
