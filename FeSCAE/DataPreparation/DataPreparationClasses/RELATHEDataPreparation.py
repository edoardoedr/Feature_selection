...
class RELATHEDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "RELATHE.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_relathe"
    label_column = "label_relathe"

    relathe_data_prep = RELATHEDataPreparation(input_folder, output_folder, label_column)
    processed_data = relathe_data_prep.process_data()
