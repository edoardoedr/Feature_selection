...
class PCMACDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "PCMAC.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_pcmac"
    label_column = "label_pcmac"

    pcmac_data_prep = PCMACDataPreparation(input_folder, output_folder, label_column)
    processed_data = pcmac_data_prep.process_data()
