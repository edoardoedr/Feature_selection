...
class GisetteDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "gisette.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_gisette"
    label_column = "label_gisette"

    gisette_data_prep = GisetteDataPreparation(input_folder, output_folder, label_column)
    processed_data = gisette_data_prep.process_data()
