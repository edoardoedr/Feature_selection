...
class CLLSub111DataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "CLL-SUB-111.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_cll_sub_111"
    label_column = "label_cll_sub_111"

    cll_data_prep = CLLSub111DataPreparation(input_folder, output_folder, label_column)
    processed_data = cll_data_prep.process_data()
