...
class ProstateDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "Prostate-GE.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_prostate"
    label_column = "label_prostate"
    
    prostate_data_prep = ProstateDataPreparation(input_folder, output_folder, label_column)
    processed_data = prostate_data_prep.process_data()
