...
class IsoletDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "Isolet.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_isolet"
    label_column = "label_isolet"

    isolet_data_prep = IsoletDataPreparation(input_folder, output_folder, label_column)
    processed_data = isolet_data_prep.process_data()
