...
class LungSmallDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "lung_small.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_lung_small"
    label_column = "label_lung_small"

    lung_small_data_prep = LungSmallDataPreparation(input_folder, output_folder, label_column)
    processed_data = lung_small_data_prep.process_data()
