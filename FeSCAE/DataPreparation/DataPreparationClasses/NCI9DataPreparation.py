...
class NCI9DataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "nci9.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_nci9"
    label_column = "label_nci9"

    nci9_data_prep = NCI9DataPreparation(input_folder, output_folder, label_column)
    processed_data = nci9_data_prep.process_data()
