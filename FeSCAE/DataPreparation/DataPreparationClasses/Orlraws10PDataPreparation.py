...
class Orlraws10PDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "orlraws10P.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_orlraws10p"
    label_column = "label_orlraws10p"

    orlraws_data_prep = Orlraws10PDataPreparation(input_folder, output_folder, label_column)
    processed_data = orlraws_data_prep.process_data()
