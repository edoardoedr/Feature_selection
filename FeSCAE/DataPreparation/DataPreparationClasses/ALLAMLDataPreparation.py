...
class ALLAMLDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "ALLAML.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_allaml"
    label_column = "label_allaml"

    allaml_data_prep = ALLAMLDataPreparation(input_folder, output_folder, label_column)
    processed_data = allaml_data_prep.process_data()
