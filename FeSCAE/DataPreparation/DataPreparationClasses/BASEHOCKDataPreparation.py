...
class BASEHOCKDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "BASEHOCK.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_basehock"
    label_column = "label_basehock"

    basehock_data_prep = BASEHOCKDataPreparation(input_folder, output_folder, label_column)
    processed_data = basehock_data_prep.process_data()
