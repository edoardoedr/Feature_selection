...
class ArceneDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "arcene.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_arcene"
    label_column = "label_arcene"

    arcene_data_prep = ArceneDataPreparation(input_folder, output_folder, label_column)
    processed_data = arcene_data_prep.process_data()
