...
class MadelonDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "madelon.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_madelon"
    label_column = "label_madelon"

    madelon_data_prep = MadelonDataPreparation(input_folder, output_folder, label_column)
    processed_data = madelon_data_prep.process_data()
