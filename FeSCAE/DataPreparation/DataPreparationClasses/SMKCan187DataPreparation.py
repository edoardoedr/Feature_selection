...
class SMKCan187DataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "SMK-CAN-187.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_smk_can_187"
    label_column = "label_smk_can_187"

    smk_data_prep = SMKCan187DataPreparation(input_folder, output_folder, label_column)
    processed_data = smk_data_prep.process_data()
