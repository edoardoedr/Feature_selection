...
class USPSDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "USPS.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_usps"
    label_column = "label_usps"

    usps_data_prep = USPSDataPreparation(input_folder, output_folder, label_column)
    processed_data = usps_data_prep.process_data()
