...
class CarcinomDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "Carcinom.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_carcinom"
    label_column = "label_carcinom"

    carcinom_data_prep = CarcinomDataPreparation(input_folder, output_folder, label_column)
    processed_data = carcinom_data_prep.process_data()
