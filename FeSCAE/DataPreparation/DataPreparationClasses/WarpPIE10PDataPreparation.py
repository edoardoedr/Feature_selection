...
class WarpPIE10PDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "warpPIE10P.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_warppie10p"
    label_column = "label_warppie10p"

    warppie_data_prep = WarpPIE10PDataPreparation(input_folder, output_folder, label_column)
    processed_data = warppie_data_prep.process_data()
