...
class ORLDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "ORL.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_orl"
    label_column = "label_orl"

    orl_data_prep = ORLDataPreparation(input_folder, output_folder, label_column)
    processed_data = orl_data_prep.process_data()
