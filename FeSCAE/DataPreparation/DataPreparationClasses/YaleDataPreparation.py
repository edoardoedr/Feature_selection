...
class YaleDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "Yale.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_yale"
    label_column = "label_yale"

    yale_data_prep = YaleDataPreparation(input_folder, output_folder, label_column)
    processed_data = yale_data_prep.process_data()
