...
class GLIOMADataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "GLIOMA.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_glioma"
    label_column = "label_glioma"

    glioma_data_prep = GLIOMADataPreparation(input_folder, output_folder, label_column)
    processed_data = glioma_data_prep.process_data()
