...
class WarpAR10PDataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "warpAR10P.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_warpar10p"
    label_column = "label_warpar10p"

    warpar_data_prep = WarpAR10PDataPreparation(input_folder, output_folder, label_column)
    processed_data = warpar_data_prep.process_data()
