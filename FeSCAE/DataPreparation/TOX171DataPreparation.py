...
class TOX171DataPreparation(BaseDataPreparation):
    def load_data(self):
        return loadmat(os.path.join(self.input_folder, "TOX-171.mat"))
...
if __name__ == "__main__":
    ...
    output_folder = "/home/edofroses/genomics/prova_tox171"
    label_column = "label_tox171"
    
    tox171_data_prep = TOX171DataPreparation(input_folder, output_folder, label_column)
    processed_data = tox171_data_prep.process_data()
