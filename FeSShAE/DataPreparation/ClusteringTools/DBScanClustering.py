...
def group_features_by_dbscan(df, params_dbscan, mode='searching', output_dir='dataset_training'):
...
def params_search_dbscan(df, output_dir='dataset_training'):
    ...
    jobs = [delayed(group_features_by_dbscan)(df, p, mode='searching', output_dir=output_dir) for p in params]
