...
def group_features_by_hierarchical_clustering(df, params_hierarchical_clustering, mode='searching', output_dir='dataset_training'):
...
def params_search_hierarchical_clustering(df, output_dir='dataset_training'):
    ...
    jobs = [delayed(group_features_by_hierarchical_clustering)(df, p, mode = 'searching', output_dir = output_dir) for p in params]
