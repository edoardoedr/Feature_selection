...
def group_features_by_kmeans(df, params_kmeans, mode='searching', output_dir='dataset_training'):
...
def params_search_kmeans(df, output_dir='dataset_training'):
    ...
    jobs = [delayed(group_features_by_kmeans)(df, p, mode='searching', output_dir=output_dir) for p in params]
