...
from pyclustering_custom.core.tests import ut_package as core_package_unit_tests

import os

from pyclustering_custom.core.definitions import PATH_PYCLUSTERING_CCORE_LIBRARY
