...
from pyclustering_custom.utils.tests.sampling_templates import sampling_test_template

from pyclustering_custom.utils.sampling import reservoir_x, reservoir_r
