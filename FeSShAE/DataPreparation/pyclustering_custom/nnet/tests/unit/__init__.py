...
from pyclustering_custom.nnet.tests.unit import ut_cnn as nnet_cnn_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_dynamic_visualizer as nnet_dynamic_visualizer_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_fsync as nnet_fsync_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_hhn as nnet_hhn_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_hysteresis as nnet_hysteresis_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_legion as nnet_legion_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_nnet as nnet_network_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_pcnn as nnet_pcnn_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_som as nnet_som_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_sync as nnet_sync_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_syncpr as nnet_syncpr_unit_tests
from pyclustering_custom.nnet.tests.unit import ut_syncsegm as nnet_syncsegm_unit_tests
