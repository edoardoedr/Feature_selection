...
from pyclustering_custom.nnet.som import som;
from pyclustering_custom.nnet.som import type_conn;
from pyclustering_custom.nnet.som import type_init;
from pyclustering_custom.nnet.som import som_parameters;
