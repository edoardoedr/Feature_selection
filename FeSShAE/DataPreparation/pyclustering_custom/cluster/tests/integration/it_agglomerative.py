...
from pyclustering_custom.cluster.tests.agglomerative_templates import AgglomerativeTestTemplates;
from pyclustering_custom.cluster.agglomerative import agglomerative, type_link;

from pyclustering_custom.samples.definitions import SIMPLE_SAMPLES;

from pyclustering_custom.core.tests import remove_library, corrupt_library;
