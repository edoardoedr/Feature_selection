...
from pyclustering_custom.nnet import initial_type, conn_represent, solve_type

from pyclustering_custom.cluster.tests.syncnet_templates import SyncnetTestTemplates
